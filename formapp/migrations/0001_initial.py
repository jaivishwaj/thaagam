# Generated by Django 5.1b1 on 2024-07-22 06:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('what_dispossed', models.CharField(blank=True, max_length=100, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('policeStationDetails', models.TextField(blank=True, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('res_photo1', models.ImageField(blank=True, null=True, upload_to='res_photos1/')),
                ('res_photo2', models.ImageField(blank=True, null=True, upload_to='res_photos2/')),
                ('res_letter', models.CharField(max_length=100)),
                ('small_narration', models.TextField()),
                ('geno1', models.ImageField(blank=True, null=True, upload_to='genograms1/')),
                ('geno2', models.ImageField(blank=True, null=True, upload_to='genograms2/')),
                ...
                ('hl_photo1', models.ImageField(blank=True, null=True, upload_to='homeless_photos1/')),
                ('hl_photo2', models.ImageField(blank=True, null=True, upload_to='homeless_photos2/')),
                ('reason_for_homeless', models.TextField()),
                ('stre_and_weak', models.TextField()),
                ('fact', models.TextField()),
                ('rehab_photo1', models.ImageField(blank=True, null=True, upload_to='rehab_photo1/')),
                ('rehab_photo2', models.ImageField(blank=True, null=True, upload_to='rehab_photo2/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100)),
                ('uqid', models.CharField(default=0, max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('photo_url', models.ImageField(blank=True, null=True, upload_to='photos/')),
                ('user', models.CharField(max_length=200)),
                ('uqid', models.AutoField(editable=False, primary_key=True, serialize=False, unique=True)),
                ('name', models.CharField(max_length=100)),
                ('Aid_no', models.IntegerField()),
                ...
                ('Action_takenup', models.TextField(blank=True, null=True)),
                ...
                ('police_memo', models.CharField(blank=True, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo_url', models.ImageField(blank=True, null=True, upload_to='rehabitation_photos/')),
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('superuser', 'Superuser'), ('staff', 'Staff')], max_length=20)),
                ('email', models.EmailField(max_length=254, unique=True)),
                ('mobile_number', models.IntegerField()),
                ('gcc_name', models.CharField(blank=True, max_length=100, null=True)),
                ('gcc_location', models.CharField(blank=True, max_length=100, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
